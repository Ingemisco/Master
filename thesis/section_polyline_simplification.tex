...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/simpl-ex-orig.png}
        %\caption{Subfigure A description}
        %\label{fig:sub1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/simpl-ex-2.png}
        %\caption{Subfigure B description}
        %\label{fig:sub2}
    \end{subfigure}
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/simpl-ex-5.png}
        %\caption{Subfigure C description}
        %\label{fig:sub3}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/simpl-ex-10.png}
        %\caption{Subfigure D description}
        %\label{fig:sub4}
    \end{subfigure}
    
    \caption{Global polyline simplifications for different \(\varepsilon\).}
    \label{fig:my_figure}
\end{figure}
...
\begin{figure}[htbp]
  \centering
	\includegraphics[width=5cm, height=8cm]{./figures/local-global-bigdiff.png}
...
Unlike the previous example, this one uses mostly irrational coordinates. If one wants to test a simplification algorithm on such a polyline, we recommend placing the points not exactly on the circle but at a distance of \((1-\mu)\varepsilon\) from the center where \(\mu > 0\) is very small, otherwise, the global simplification might not be found. If the points are too close to the center the local simplification might be smaller. For this reason we have also provided the more stable previous example.
